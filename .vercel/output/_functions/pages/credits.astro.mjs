...
</a> ${renderComponent($$result2, "Developers", Developers, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Aberration/Downloads/mgg_fun_site/src/components/Developers.svelte", "client:component-export": "default", "data-astro-cid-cak72j2b": true })} </div> ` })} `;
}, "C:/Users/Aberration/Downloads/mgg_fun_site/src/pages/credits.astro", void 0);

const $$file = "C:/Users/Aberration/Downloads/mgg_fun_site/src/pages/credits.astro";
const $$url = "/credits";
