...
<style>
  ...
  /* Текст и цифра в одну строку, как у ХП */
  .attack-info{
    display: flex;
  ...
  /* Шрифт названия атаки такой же серый, как лейбл "HP" */
  .attack-label{
    font-weight: 600; /* Чуть тоньше чем было */
    color: #aab6c8;   /* Серый цвет вместо белого */
    font-size: 13px;
    white-space: normal;
    overflow: hidden;
  ...
  /* Цифра атаки такая же белая и жирная, как значение HP */
  .attack-damage{
    font-size: 14px;
    font-weight: 700;
    color: #e9eef6; /* Белый цвет */
    white-space: nowrap;
  }
