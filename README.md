...
**Главная база знаний и набор инструментов для игры Mutants Genetic Gladiators.**

Мы возрождаем сообщество с помощью современных технологий. На сайте доступны: **Вики мутантов и скинов, симуляторы рулеток, скрещивания, реактора и даже крафта. Так же калькуляторы статов, и эво.**

---

### 🛠 Стек технологий

![Astro](https://img.shields.io/badge/Astro-SSG-FF5D01?style=for-the-badge&logo=astro)
