...
## Qwen Added Memories
- Проект Archivist Library (MGG Hub) - сайт для игры Mutants Genetic Gladiators. Основные файлы, которые редактировались: 1) src/components/MutantsBrowser.svelte - страница мутантов, сортировка, фильтрация; 2) src/components/StatsCalculator.svelte - калькулятор статов, улучшения масштабирования, уведомления; 3) src/components/MutantModal.svelte - модальное окно мутанта, исправление отображения генов атаки; 4) src/components/breeding/BreedingUI.svelte - симулятор скрещиваний, добавление второй линии генов; 5) src/lib/search-normalize.ts - улучшенная нормализация поиска для специальных символов. Ключевые исправления: согласованное отображение генов атаки (всегда из lvl30 данных), улучшенный поиск (Кр€з -> крез), фильтрация по двум генам, уведомления при скриншоте.
